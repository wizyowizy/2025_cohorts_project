  ...
  <body bgcolor="#00FF00">
    ...
    <!--Form declaration. Must have an action attribute -->
        <form action="C:/JonnyJava/FirstJava.html/profile.html" method="post">
            <p>Let us learn something about your web music lifestyle. This will help the entire world know about your busness </p> <!--This control is for mutplie line comment-->
            <textarea name="comments" cols="30" rows="5"></textarea>

            <p>select your favourite genre of music and movies <br /> <!--Radion control. only one selection possible-->
